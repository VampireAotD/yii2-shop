...
class SignupForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['confirm', 'required'],
            ['confirm', 'compare', 'compareAttribute' => 'password', 'skipOnEmpty' => false, 'message' => Yii::t('forms','Passwords are not equal')]
        ];
    }
    ...
    protected function sendEmail($user)
    {
        return Yii::$app
            ...
            ->setTo($this->email)
            ->setSubject('Новый аккаунт на ' . Yii::$app->name)
            ->send();
    }
}
