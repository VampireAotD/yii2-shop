...
class ManageController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'update', 'approve', 'dismiss', 'create', 'delete'],
    ...
    public function actionApprove($id)
    {
        $model = $this->findModel($id);
        $model->approve();
        Yii::$app->session->setFlash('success', 'Order has been approved!');
    ...
    public function actionDismiss($id)
    {
        $model = $this->findModel($id);
        $model->dismiss();
        Yii::$app->session->setFlash('success', 'Order has been dismissed!');
        return $this->redirect(Yii::$app->request->referrer);
    }
